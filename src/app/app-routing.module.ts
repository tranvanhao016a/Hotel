...
const routes: Routes = [{ path: 'home', loadChildren: () => import('./pages/customs/home/home.module').then(m => m.HomeModule) }, { path: 'about', loadChildren: () => import('./pages/about/about.module').then(m => m.AboutModule) }, 
